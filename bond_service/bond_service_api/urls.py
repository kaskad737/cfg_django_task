...
urlpatterns = [
    ...
    path('users/<uuid:pk>/', UserRetrieveUpdateDestroyView.as_view(), name='user_details'),
    path('portfolio/', PortfolioListCreateView.as_view(), name='portfolio'),
    path('portfolio/<uuid:pk>/', PortfolioRetrieveUpdateDestroyView.as_view(), name='portfolio_details'),
    ...
    path('bonds/<uuid:pk>/', BondRetrieveUpdateDestroyView.as_view(), name='bond_details'),
]
